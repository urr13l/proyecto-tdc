...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2022 a las 15:22:59
...
CREATE TABLE IF NOT EXISTS `administrador` (
  ...
  `c_nombre` int(11) NOT NULL,
  `c_contrasenia` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `c_id_tarjeta` int(3) NOT NULL,
  PRIMARY KEY (`c_id_usuario`),
  KEY `c_id_tarjeta` (`c_id_tarjeta`)
