...
<ul id="slide-out" class="sidenav">
    ...
    <li><a href="#!"><i class="material-icons">airport_shuttle</i>Viajes</a></li>
  ...
  <!--Contenido principal de la pagina web
    ...
    <div class="col s2" >
      ...
      <!-- <div class="carousel carousel-slider col s8" >
        <a class="carousel-item" href="#"><img src="imagenes/carr1.png"/></a>
        <a class="carousel-item" href="#"><img src="imagenes/carr2.png" /></a>
        <a class="carousel-item" href="#"><img src="imagenes/carr3.png" /></a>
      </div> -->
